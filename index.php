...
if (isset($_POST['submit'])) {
    ...
    $errors = array();
    //Validation Check to make sure all the fields are correct
    if(empty($firstName)) {
    ...
    // Maps the selected option to the corresponding numeric value
...
//Values for different checkbox options
...
// Construct the SQL statement to check the data
$query = "SELECT * FROM Contact";

// Execute the sql statment
$result = mysqli_query($connect, $query);
/* Checks the table to confirm that the database has been populated
// Check if the query was successful
if ($result) {
...
<html lang = "en">
 ...
 <body>
    <header class = "site-header" >
        ...
        <img class="logo-image" alt="WEDevelopNow logo" src="img/WeDevelopNow_logo.png" title="WeDevelopNow">
        </div>
    </header>
    <div class="topnav">
    <div class = "items">
  <a href = https://www.apprenticetips.com/blog>Apprenticeships</a>
...
<textarea class="comments" name="comments" placeholder="Please provide any other information that you wish to let the recruiters know...."></textarea> 
